...
class EnrollmentViewSet(viewsets.ModelViewSet):
    ...
    def mark_lesson_viewed(self, request, pk=None):
        ...
        lesson_progress, created = LessonProgress.objects.get_or_create(
            enrollment=enrollment, lesson_id=lesson_id, defaults={"is_viewed": True, "completion_percentage": 100}
        )
        ...
        viewed_lessons = LessonProgress.objects.filter(enrollment=enrollment, is_viewed=True).count()
        ...
        return Response({"message": "Lesson marked as viewed", "progress_percentage": enrollment.progress_percentage})
